                ...
                if (null != this.reader.getContext().leaves()) {
					...
					simInfo.doc = d;
                                ...
                                if (SearchManager.loggingMode.equals("D")) {
                                    System.out.println("docEnum is null, "
                                            + base + ", term: "
                                            + this.searchTerm
                                            + Util.debug_thread());
                                }
                            ...
                            System.out.println("exception caught "
                                    + e.getMessage() + Util.debug_thread()
                    ...
                    if (SearchManager.loggingMode.equals("D")) {
                        System.out.println("leaves are null, "
                                + this.searchTerm + Util.debug_thread());
                    }
                }
            } else {
                if (SearchManager.loggingMode.equals("D")) {
                    System.out.println("getContext is null, " + this.searchTerm
                            + Util.debug_thread());
                }
            }
        } else {
            if (SearchManager.loggingMode.equals("D")) {
                System.out.println("this.reader is null, " + this.searchTerm
                        + Util.debug_thread());
            }
        }
    }
