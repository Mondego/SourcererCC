...
public class SocketWriter {
	...
	private static final Logger logger = LogManager.getLogger(SocketWriter.class);
	...
	/*public static void main(String args[]){
		SocketWriter s = new SocketWriter(9999,"localhost");
		s.openSocketForWriting();
		s.writeToSocket("hi this is java here");
		s.writeToSocket("having a good day");
		s.writeToSocket("msg 3");
