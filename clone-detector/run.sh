...
for ((c=1;c<=$loops;c++))
do
	echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetector.jar $prefix $th overlap"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetector.jar $prefix $th jaccard"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_none overlap"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_none jaccard"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_cv overlap"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_cv jaccard"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_c overlap"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_c jaccard"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_v overlap"
...
for ((c=1;c<=$loops;c++))
do
    echo "\e[32m[run.sh] \e[0mrunning java -jar dist/noindex.CloneDetectorWithFilter.jar $prefix $th 0 pos_filter_v jaccard"
