...
colNames=["block1","block2", "isClone", "COMP1", "NOS1", "HVOC1", "HEFF1", "CREF1", "XMET1", "LMET1","NOA1", "HDIF1", "VDEC1", "EXCT1", "EXCR1", "CAST1", "NAND1", "VREF1", "NOPR1", "MDN1", "NEXP1", "LOOP1","NBLTRL1","NCLTRL1","NNLTRL1","NNULLTRL1","NSLTRL1","COMP2", "NOS2", "HVOC2", "HEFF2", "CREF2", "XMET2", "LMET2","NOA2", "HDIF2", "VDEC2","EXCT2", "EXCR2", "CAST2", "NAND2", "VREF2", "NOPR2", "MDN2", "NEXP2", "LOOP2","NBLTRL2","NCLTRL2","NNLTRL2","NNULLTRL2","NSLTRL2"]
...
file_output.write(classification_report(Y_test.astype(bool), y_pred_classes))
file_output.close()
