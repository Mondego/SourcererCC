cloneworks_clones_file_path='/lv_scratch/scratch/mondego/local/CloneWorks-0.3/recall_dataset_conservative_th_7_mit1.clones.csv'
# nicad_clones_file_path='D:\\PhD\\Clone\\nicad_results.txt'
clonepairs_output_path='/lv_scratch/scratch/mondego/local/CloneWorks-0.3/cwpais_conservative_th_7_mit1_bceformatted.txt'
